...
class TestSwarmMonitoringEndpoints:
    ...
    def test_list_active_swarms_empty(self, client: TestClient, auth_headers: dict) -> None:
        """GET /swarms/active returns empty list when no swarms running."""
        response = client.get("/api/v1/swarms/active", headers=auth_headers)
        assert response.status_code == 200

        data = response.json()
        assert data["swarms"] == []

    def test_list_active_swarms_returns_running_only(self, client: TestClient, auth_headers: dict) -> None:
    ...
    def test_list_completed_swarms(self, client: TestClient, auth_headers: dict) -> None:
        ...
        response = client.get("/api/v1/swarms/completed", headers=auth_headers)
        assert response.status_code == 200
    ...
    def test_list_completed_swarms_respects_limit(self, client: TestClient, auth_headers: dict) -> None:
        ...
        response = client.get("/api/v1/swarms/completed?limit=5", headers=auth_headers)
        assert response.status_code == 200

        data = response.json()
        assert len(data["swarms"]) == 5

    def test_get_swarm_log_success(self, client: TestClient, auth_headers: dict) -> None:
        ...
        response = client.get(f"/api/v1/swarms/{swarm_id}/log", headers=auth_headers)
        assert response.status_code == 200
    ...
    def test_get_swarm_log_not_found(self, client: TestClient, auth_headers: dict) -> None:
        """GET /swarms/{id}/log returns 404 for non-existent swarm."""
        response = client.get("/api/v1/swarms/999/log", headers=auth_headers)
        assert response.status_code == 404

    def test_get_swarm_log_null_log(self, client: TestClient, auth_headers: dict) -> None:
